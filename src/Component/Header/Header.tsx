    ...
    <>
      <Box>
        <Box sx={{ display: "flex", justifyContent: "space-between", marginTop: "11px" }}>
          <Typography sx={{ borderRight: '1px solid grey', pr: 1, fontSize: "12px", marginLeft: "69px" }}>
            +91 9024609609
          </Typography>
          <Typography sx={{ color: "gray", fontSize: "11.8px ", marginLeft: "11px" }}>
            SAVOUR AUTHENTIC RAJASTHANI FLAVOR AT YOUR DOORSTEP.
          </Typography>
          <Typography sx={{ borderLeft: '1px solid grey', pl: 1, color: "gray", fontSize: "11.8px ", marginRight: "88px" }}>
            DELIVERY ALL ACROSS INDIA & WORLDWIDE
          </Typography>
        </Box>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-around', marginRight: "90px", marginTop: "17px", alignItems: 'center' }}>
            <Box
              ...
              <Search navigate={navigate} /> {/* Pass navigate prop */}
            </Box>

            <IconButton><UserOutlinedIcon /></IconButton>
            <IconButton onClick={handleCartClick}><ShoppingBagIcon /></IconButton>
